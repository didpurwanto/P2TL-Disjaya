    ...
    var newWin = window.open (URL, title, 'toolbar=no, location=no,directories=no, status=no, menubar=no, scrollbars=no, resizable=no,copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
				...
				<div class="col-lg-5">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                           <a href="javascript:void(0);" onClick ="PopupWindowCenter('<? echo base_url('index.php/pages/printp2tl')."/".$id_lap?>', 'PopupWindowCenter',600,600)">Klik Disini Untuk Cetak Surat Tugas</a>
                        </div>
                    </div>
                </div>
                <!-- /.col-lg-4 -->
