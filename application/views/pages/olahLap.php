                ...
                <div class="col-lg-7">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Menu ini digunakan untuk mengesahkan dan menentukan apakah kasus pada input laporan 1 termasuk P2TL atau non P2TL  
                        </div>
                        <!-- /.panel-heading -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
							<h3>Tindakan ASMAN/DM</h3>
                            Berikan tindakan berdasarkan data-data yang ada pada laporan olah laporan 1
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <form role="form" action="<?echo base_url('index.php/pages/lap2')?>" method="POST">     										
                                        <div class="form-group">
